import { it, expect, describe, vi, beforeEach } from "vitest"; //describe = groups test together
...
describe("Product Component", () => {
 ...
 beforeEach(()=>{
    ...
    loadCart=vi.fn(); // vi.fn() = create fake function that doesnt do anything
  });
  ...
  it("adds a products to cart", async () => {
    render(<Product product={product} loadCart={loadCart} />);
...
// to button click function @testing-library/user-event
// lets us simulate events (like clicking button)
